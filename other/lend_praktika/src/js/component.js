(function($) {
    ...
    if ($(window).width() > 1200) {
        ...
        $('.rght').addClass("hidden_animation").viewportChecker({
            classToAdd: 'visible animated fadeInRight', // Class to add to the elements when they are visible
            offset: 10
        });
        $('.lft, .summary-list li').addClass("hidden_animation").viewportChecker({
        ...
        $('.print, .rIn').addClass("hidden_animation").viewportChecker({
        ...
        $('.znd').addClass("hidden_animation").viewportChecker({
